...
import { Location, NgIf, NgFor, DatePipe, NgClass } from '@angular/common';
...
<div class="notif-page pt-5">
  ...
  <div class="filter-tabs">
    ...
    <button [class.active]="activeFilter() === 'unread'" (click)="activeFilter.set('unread')">Unread</button>
    <button [class.active]="activeFilter() === 'promo'" (click)="activeFilter.set('promo')">Offers</button>
  </div>

  <!-- Notifications List -->
  <div class="notif-content">

    <ng-container *ngIf="filteredNotifs().length > 0; else emptyState">
      <div
        *ngFor="let n of filteredNotifs()"
        ...
        <div class="notif-body">
          ...
          <span class="notif-time">{{ n.date | date: 'd MMM, h:mm a' }}</span>
        </div>
      </div>
    </ng-container>
...
export class NotificationsComponent {
  ...
  notifications = signal<Notification[]>([
    { id: 1, title: '🎉 Welcome to AuraPark!', message: 'Thanks for joining AuraPark. Start exploring parking spots near you right now.', type: 'success', date: new Date('2026-04-01T09:00:00'), read: false },
    { id: 2, title: '🔥 Limited Time Offer', message: 'Get 20% off on your first 3 bookings this week. Use code AURA20 at checkout.', type: 'promo', date: new Date('2026-03-31T14:30:00'), read: false },
    { id: 3, title: '📍 New Spots in Your Area', message: '5 new parking spots have been listed near Satellite Road, Ahmedabad. Check them out!', type: 'info', date: new Date('2026-03-30T11:00:00'), read: false },
    { id: 4, title: '⚠️ App Maintenance Notice', message: 'AuraPark will undergo scheduled maintenance on April 5, 2026 from 2 AM to 4 AM IST.', type: 'warning', date: new Date('2026-03-29T08:00:00'), read: true },
    { id: 5, title: '🚗 Peak Hour Alert', message: 'High demand expected near CG Road this Friday evening. Book your spot in advance!', type: 'warning', date: new Date('2026-03-28T16:00:00'), read: true },
    { id: 6, title: '🎁 Refer & Earn', message: 'Invite your friends to AuraPark and earn ₹50 credit for every successful referral.', type: 'promo', date: new Date('2026-03-27T10:00:00'), read: true },
    { id: 7, title: '✅ Profile Verified', message: 'Your AuraPark account has been successfully verified. You now have full access to all features.', type: 'success', date: new Date('2026-03-26T09:00:00'), read: true },
  ]);
